...
<section id="intro" class="full-screen-section active-section">
        ...
        <div class="intro-header">
            <img src="<?php echo get_template_directory_uri().'/assets/img/intro/intro-header.png'?>" />
        </div>
        <div class="intro-subheader">
            <div>Новый имидж</div>
            <div>рекламно-производственная компания</div>
        </div>
...
<section id="services" class="full-screen-section next-section">
        <a href="/html/design.html" class="panel primary-services">
            <div class="primary-services-info">
                <div class="services-header">Дизайн</div>
                <div class="services-text">Пред&shy;ла&shy;га&shy;ем ши&shy;ро&shy;кий спектр ус&shy;луг 
                    ...
                    про&shy;дук&shy;ции, за&shy;ни&shy;ма&shy;ем&shy;ся оформ&shy;ле&shy;ни&shy;ем.
                </div>
            </div>
        ...
        <a href="/html/polygraphy.html" class="panel primary-services">
            <div class="primary-services-info">
                <div class="services-header">Полиграфия</div>
                <div class="services-text">Одно из нап&shy;рав&shy;ле&shy;ний де&shy;я&shy;тель&shy;нос&shy;ти на&shy;шей ком&shy;па&shy;нии пос&shy;тав&shy;ка и пе&shy;чать по&shy;ли&shy;гра&shy;фи&shy;чес&shy;кой рек&shy;лам&shy;ной про&shy;дук&shy;ции.</div>
            </div>
        ...
        <a href="/html/cards.html" class="panel primary-services">
            <div class="primary-services-info">
                <div class="services-header">Пластиковые карты</div>
            ...
            <div class="services-logo"><img src="<?php echo get_template_directory_uri().'/assets/img/contrast_logo_inv.png'?>" /></div>
        </a>
...
<section id="services1" class="full-screen-section next-section">
        ...
        <a href="/html/plotter.html" class="panel secondary-services">
            ...
            <div class="secondary-services-info">
                <div class="services-header">НАКЛЕЙКИ<br>ПЛОТТЕРНАЯ РЕЗКА</div>
                <div class="services-text">Раз&shy;меры на&shy;кл&shy;ек для пе&shy;ча&shy;ти мо&shy;гут быть са&shy;мым&shy;и раз&shy;но&shy;об&shy;раз&shy;ны&shy;ми. Мы из&shy;го&shy;то&shy;вим для вас на&shy;клей&shy;ки лю&shy;бо&shy;го раз&shy;ме&shy;ра: от сов&shy;сем кро&shy;шеч&shy;ных на&shy;кле&shy;ек-сти&shy;ке&shy;ров, до объем&shy;ных и боль&shy;ших на&shy;кле&shy;ек на вит&shy;ри&shy;ны и стек&shy;ла, и да&shy;же на&shy;кле&shy;ек для выс&shy;та&shy;воч&shy;ных стен&shy;дов.</div>
            </div>
...
<section id="about" class="full-screen-section next-section">
        <div class="about-left">
            <div class="about-left-content">
                <div class="about-left-content-header">О компании</div>
        ...
        <div class="about-right">
            <div class="wrapper">
                <img class="back" src="<?php echo get_template_directory_uri().'/assets/img/about/center-logo-inv-reflect.png'?>">
                <img class="face" src="<?php echo get_template_directory_uri().'/assets/img/about/center-logo.png'?>">
            </div>
        </div>
